    ...
    return (
        <div>
            <header className="bg-white">
                <nav className={`${openNavbar ? 'translate-y-0 top-16' : '-translate-y-full top-0'} transition duration-300 fixed flex flex-col border-t border-gray-300 gap-4 py-6 px-6 left-0 right-0 bg-white z-[1500]`}>
